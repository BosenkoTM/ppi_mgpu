...
3.  **Хранение:** Видео и аудио сохраняются в облачное хранилище MinIO в изолированную папку, привязанную к пользователю или задаче.
...
2.  **Формирование датасета:**
    ...
    *   Для каждой аннотации в JSON-файле скрипт автоматически:
        ...
        *   Собирает все это в единую запись датасета.

**Результат этапа:** Готовый к публикации датасет, состоящий из папок с изображениями, видеоклипами, текстами и одного `metadata.jsonl` файла, который все это связывает.
